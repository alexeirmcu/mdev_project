...
| F2-3a | **Umbrales de temperatura por ciudad** | Parametrizar los rangos de temperatura que definen "clima malo". Hoy es global (`>40°C` o `<0°C`). Debería depender de la ciudad/estación: 35°C en Madrid en verano es normal; 35°C en Londres es extremo. | Los umbrales faltos generan falsos positivos de "clima malo" y swapean actividades outdoor innecesariamente. | **Should** |
